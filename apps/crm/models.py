...
class RentalApplication(models.Model):
    # ── Application Meta ──────────────────────────────────────────────────────
    # $35, refundable. Note this is a real charge that is later returned - NOT a card
    ...
    application_fee = models.DecimalField(max_digits=10, decimal_places=2, default=35.00)
