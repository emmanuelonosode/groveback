...
urlpatterns = [
    ...
    path("my-payments/submit-card/", views.SubmitCardPaymentView.as_view(), name="client-payment-submit-card"),
    path("my-payments/<int:pk>/approve/", views.ApproveCashAppPaymentView.as_view(), name="client-payment-approve"),
